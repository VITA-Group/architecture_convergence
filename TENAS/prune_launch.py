...
TORCH_HOME = "/path/to/nas-bench-201"  # Path that contains the nas-bench-201 database. If you only want to run on NASNET (i.e. DARTS) search space, then just leave it empty
data_paths = {
    "cifar10": "/path/to/cifar.python",
    "cifar100": "/path/to/cifar.python",
    "ImageNet16-120": "/path/to/ImageNet16",
    "imagenet-1k": "/path/to/imagenet2012",
}
